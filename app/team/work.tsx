...
const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    content:
      "No need to job hunt to learn new tech or switch roles—we’ll support your transition within Golden Code.",
  },
  {
    id: 6,
    icon: icon6,
    ...
    content:
      "We value people as Golden Code greatest asset and ensure hierarchy never works against our employees.",
  },
];
