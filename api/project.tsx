...
const Project = [
  {
    ...
    description:
      "Ezhalha is a ride-hailing marketplace that combines on-demand dispatch like Uber with passenger-driver fare negotiation like InDrive — giving users fast rides plus flexible pricing.",
  },
  {
    Id: "2",
