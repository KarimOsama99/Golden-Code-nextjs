          ...
          <div className="header__wrap pd-70 ul_li_between">
            ...
            <div className="header-logo">
              <Link href="/" className="logo01">
                <Image src={logoWhite} alt="Golden Code Logo White" />
              </Link>
              <Link href="/" className="logo02">
                <Image src={logoBlack} alt="Golden Code Logo Black" />
              </Link>
            </div>
            ...
            <div className="main-menu__wrap ul_li navbar navbar-expand-xl">
              ...
              <div className="xb-header-wrap">
                <div
                  className={`xb-header-menu ${mobileActive ? "active" : ""}`}
                >
                  <div className="xb-header-menu-scroll lenis lenis-smooth">
                    ...
                    <div className="xb-logo-mobile xb-hide-xl">
                      <Link href="/" rel="home">
                        <Image src={logoWhite} alt="Golden Code Logo" />
                      </Link>
                    </div>
            ...
            <div className="header-contact d-none d-md-block">
              ...
              >
                Let’s talk
                <span>{/* SVG icon omitted for brevity */}</span>
              </Link>
            </div>
          </div>
        </div>
