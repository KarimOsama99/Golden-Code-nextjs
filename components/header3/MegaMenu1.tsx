...
const MegaMenu1: React.FC = () => {
  const items = [
    ...
    {
      href: "/career-details",
      icon: "/images/icon/m_08.svg",
      title: "Career Details",
      desc: "Open roles and more.",
    },
    {
      href: "/portfolio-details",
      icon: "/images/icon/m_09.svg",
      title: "Casestudy Details",
      desc: "Detailed breakdowns.",
    },
    {
      href: "/terms-conditions",
      icon: "/images/icon/m_10.svg",
      title: "Terms & Conditions",
      desc: "Your rights & responsibilities.",
    },
    {
      href: "/privacy-policy",
      icon: "/images/icon/m_11.svg",
      title: "Privacy Policy",
      desc: "Commitment to confidentiality.",
    },
  ];
