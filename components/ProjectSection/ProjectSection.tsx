...
import brand1 from "@/public/images/project/ezhalha-logo.webp";
import brand2 from "@/public/images/project/uniguide-logo.png";
import brand3 from "@/public/images/project/minbible-logo.png";
import brand4 from "@/public/images/project/salamclinic-logo.png";
      ...
      <div className="sa-project_wrapper">
        ...
        <div className="sa-projecr_brand pt-70">
          <div className="container">
            ...
            >
              {[brand1, brand4, brand2, brand3, brand4, brand1].map(
                (brand, idx) => (
                  <div
                    key={idx}
