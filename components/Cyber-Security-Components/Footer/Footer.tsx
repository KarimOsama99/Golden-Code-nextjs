        ...
        <div className="xb-footer">
          <div className="sec-title--two sec-title--three text-center mb-40">
            <span className="sub-title">
              ...
              <span>Join the Golden Code community</span>
            </span>
          </div>
          ...
          <div className="footer-inner mt-80 mb-70 ul_li_between align-items-start">
            <div className="footer-widget">
              ...
              <ul className="xb-item--holder list-unstyled">
                ...
                <li className="xb-item--list">
                  <Link href="/home-4">Processes</Link>
                </li>
                <li className="xb-item--list">
            ...
            <div className="footer-widget">
              ...
              <ul className="xb-item--holder list-unstyled">
                <li className="xb-item--list">
                  <Link href="/blog">Golden Code Blog</Link>
                </li>
                <li className="xb-item--list">
                  <Link href="/casestudy">Case Studies</Link>
                </li>
                <li className="xb-item--list">
                  <Link href="/home-4">Achievements</Link>
                </li>
                <li className="xb-item--list">
                  <Link href="/home-4">Our industries</Link>
                </li>
              </ul>
            </div>
            ...
            <div className="sa-newslatter footer-widget">
              ...
              <p className="xb-item--content clr-white">
                Sign up for Golden Code weekly updates.
              </p>
          ...
          <div className="footer-copyright mt-70 ul_li_between">
            <p className="copyright mt-20">
              Copyright © 2025 <Link href="/home-4">Golden Code</Link>. All
              rights reserved.
            </p>
            <p className="mt-20">
