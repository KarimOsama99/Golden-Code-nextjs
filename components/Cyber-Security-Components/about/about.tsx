                  ...
                  >
                    <div>
                      <p
                        ...
                        data-wow-duration="600ms"
                      >
                        With over 35 years of experience, Golden Code is a
                    ...
                    <div className="xb-content">
                      ...
                      <div className="xb-item--inner">
                        ...
                        <span className="xb-item--content">
                          Our honest specialist team members
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            {[
              {
                ...
                content: "We catch threats early to keep your systems safe.",
              },
              {
                icon: abicon2,
              ...
              },
              {
                ...
                content:
                  "We use AI to enhance and ensuring detection and automate protection.",
              },
              {
                icon: abicon4,
