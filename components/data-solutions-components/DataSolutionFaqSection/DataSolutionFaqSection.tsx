...
const FaqSection: React.FC = () => {
  ...
  const faqsLeft: Faq[] = [
    {
      number: "1",
      question: "What services does Golden Code offer?",
      answer:
        "Data integration, AI-powered insights, predictive analytics, and business intelligence.",
    },
    {
      number: "2",
      question: "How will Golden Code’s solutions help my business?",
  ...
  const faqsRight: Faq[] = [
    {
      number: "5",
      question: "Can Golden Code solutions be customized?",
      answer: "Yes, tailored to fit unique business needs.",
    },
    {
      number: "6",
      question: "How secure is my data with Golden Code?",
      answer: "Golden Code ensures top-level data security.",
    },
    {
      number: "7",
      question: "What industries does Golden Code support?",
