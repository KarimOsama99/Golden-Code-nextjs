      ...
      <div className="container">
        ...
        <div className="item_details_content pb-80">
          <ul className="post_meta ul_li list-unstyled">
            <li>
              <Link href="/blog">
                <span className="meta_label1">{blog.thumb}</span>
              </Link>
            </li>
            <li>
              <Link href="/blog">
                ...
                <span className="meta_label">{blog.create_at}</span>
              </Link>
            </li>
          </ul>
          <h2 className="item_details_heading">{blog.title}</h2>
          <p className="mb-40">{blog.description}</p>
            ...
            <div className="col-md-6">
              <ul className="post_meta list-unstyled ul_li">
                ...
                <li>
                  <Link href="/blog">
                    <span className="meta_icon">
                      <Image src={icon3} alt="Comments" />
                    </span>
                    <span className="meta_label">{blog.comment} Comments</span>
                  </Link>
                </li>
                <li>
                  <Link href="/blog">
                    <span className="meta_icon">
                      <Image src={icon4} alt="Views" />
                    </span>
