  ...
  const testimonials = [
    {
      authorImg: tImg1,
      content:
        "“Most businesses are sitting on a data gold mine within their customer profiles. We use Golden Code to get on customer interactions.”",
      name: "Laurie Leduc",
    ...
    },
    {
      authorImg: tImg2,
      content:
        "“The workflows we built in Golden Code suite allowed us to achieve or exceed customer expectations in handling urgent issues.”",
    ...
    },
    {
      authorImg: tImg3,
      content:
        "“We love Golden Code because their API allows us to explore ways to get customer data more personalized experience.”",
      name: "Sophia Turner",
                  ...
                  <div className="xb-item--holder">
                    ...
                    <div className="xb-item--box ul_li_between pt-100">
                      ...
                      <div className="xb-item--rating">
                        <span>
                          <Image src={icon2} alt="rating star icon" />{" "}
                          {testimonial.rating}
                        </span>
                      </div>
                    </div>
